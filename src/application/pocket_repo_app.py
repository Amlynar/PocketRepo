...
from src.framework.navigation.navigator import PRNavigation, PRNavigationRoute, ProjectListScreenRoute
from src.framework.navigation.manager import NavigationManager
