...
from src.framework.navigation.navigation_route import PRNavigation, PRNavigationRoute, ProjectListScreenRoute
from src.framework.navigation.navigation_manager import NavigationManager
